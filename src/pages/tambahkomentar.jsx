...
function Tambahkomentar() {
    ...
    const [komentar, setKomentar] = React.useState(null);
  ...
  return (
    <div>
      ...
      <div className="container mx-auto py-8">
        <h1 className="text-3xl font-bold mb-8">Tambah Komentar</h1>
        <form className="max-w-md mx-auto" onSubmit={handleSubmit}>
          <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="title">Nama</label>
            <input
          ...
          <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="content">Email</label>
            <textarea
              className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              id="content"
          ...
          <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="content">Komentar</label>
            <textarea
              className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              id="content"
              placeholder="Masukkan konten artikel"
